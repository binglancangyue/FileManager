...
import com.cywl.launcher.filemanager.model.tools.StoragePaTool;
...
public class CustomValue {
    ...
    public static final String LOCAL_PATH = StoragePaTool.getStoragePath(false);
    //    public static final String SD_CARD_PATH = "/storage/0000-0000";// 0000-006F
    public static final String SD_CARD_PATH = StoragePaTool.getStoragePath(true);

    public static final String LOCAL_NAME = MyApplication.getInstance().getResources().getString(R.string.home_internal_storage);
    public static final String SD_CARD_NAME = MyApplication.getInstance().getResources().getString(R.string.home_external_path);
