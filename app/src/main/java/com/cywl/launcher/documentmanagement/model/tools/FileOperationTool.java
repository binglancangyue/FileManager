...
import com.cywl.launcher.documentmanagement.BuildConfig;
...
/*            if (!oldFile.exists()) {
    ...
    public static boolean copyAll(String copyFilePath, String newFilePath) {
        if (new File(copyFilePath).isFile()) {
            return FileOperationTool.copyFile(copyFilePath, newFilePath);
        } else {
            return FileOperationTool.copyFolder(copyFilePath, newFilePath);
        }
    }
    ...
    public static void openFile(String fileDirectory) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(MyApplication.getInstance(),
