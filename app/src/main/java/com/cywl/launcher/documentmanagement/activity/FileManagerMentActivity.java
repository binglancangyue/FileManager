package com.cywl.launcher.documentmanagement.activity;
...
import com.cywl.launcher.documentmanagement.adapter.RecyclerViewAdapter;
import com.cywl.launcher.documentmanagement.adapter.ViewPageAdapter;
import com.cywl.launcher.documentmanagement.model.CustomValue;
import com.cywl.launcher.documentmanagement.model.MediaData;
import com.cywl.launcher.documentmanagement.model.bean.FileBean;
import com.cywl.launcher.documentmanagement.model.listener.OnDialogListener;
import com.cywl.launcher.documentmanagement.model.listener.OnRecyclerViewListener;
import com.cywl.launcher.documentmanagement.model.tools.FileManagementDialogTool;
import com.cywl.launcher.documentmanagement.model.tools.FileOperationTool;
import com.cywl.launcher.documentmanagement.model.tools.RequestPermissionsTool;
import com.cywl.launcher.documentmanagement.model.tools.ToastTool;
...
public class FileManagerMentActivity extends RxActivity implements View.OnClickListener,
    ...
    private static class InnerHandler extends Handler {
        private final WeakReference<FileManagerMentActivity> activityWeakReference;

        private InnerHandler(FileManagerMentActivity activity) {
        ...
        public void handleMessage(Message msg) {
            ...
            FileManagerMentActivity activity = activityWeakReference.get();
            if (activity != null) {
                switch (msg.what) {
        ...
        getWindow().getDecorView().post(new Runnable() {
            ...
            public void run() {
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                       requestPermissions(FileManagerMentActivity.this);
                        setViewPagerAdapter();
